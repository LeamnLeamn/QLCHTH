...
CREATE TABLE SanPham(
	...
	ALTER TABLE SanPham
ALTER COLUMN AnhSP nvarchar(1000);
select * from SanPham
...
/*Sản phẩm*/
insert into SanPham values (N'Dầu ăn',100000,10,N'Dầu 100% từ thiên nhiên an toàn cho sức khỏe',1,3,N'');
insert into SanPham values (N'Hạt nêm',30000,10,N'Hạt nêm được chiếc xuất từ xương 100% ',1,2,N'');
insert into SanPham values (N'Tương ớt chinsu',22000,10,N'Cay nồng vị ớt giúp món ăn thêm hấp dẫn',1,4,N'');
insert into SanPham values (N'Mì siêu cay',18000,10,N'Mì đến từ Nhật Bản vị ngon không thể tả',2,3,N'');
insert into SanPham values (N'Nước ngọt',50000,10,N'Nước ngọt có gas bùng nổ vị giác ',2,2,N'');
insert into SanPham values (N'Bột giặt',220000,10,N'Nước giặt dành cho máy giặt ',1,1,N'');
insert into SanPham values (N'Nước lao sàn',70000,10,N'Nhà sạch thì mát bát sạch ngon cơm',1,3,N'');
insert into SanPham values (N'Cải ngọt',5000,10,N' Cải ngọt tươi từ đà lạt ',3,2,N'');
insert into SanPham values (N'Cà chua',22000,10,N'Cà chua tươi đến từ đà lạt',3,1,N'
');
